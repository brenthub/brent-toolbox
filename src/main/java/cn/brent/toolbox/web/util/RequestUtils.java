package cn.brent.toolbox.web.util;
...
public class RequestUtils {
     ...
     * 获取nginx 代理后的真实ip
     */
    public static String getRemoteSeverIp(HttpServletRequest request){
    ...
    public static String getDomain(HttpServletRequest request){
    	...
    	if(StringUtils.isNotEmpty(request.getParameter(pname))){
    		host=request.getParameter(pname);
    	}else if(StringUtils.isNotEmpty(request.getHeader(pname))){
    		host=request.getHeader(pname);
    	}else{
	...
	public static String[] getStringParamValues(HttpServletRequest req, String name){
		String[] values = req.getParameterValues(name);
		if(values==null) return null;
		return values;
	}
